...
setup(
  name = 'Try',         # How you named your package folder (MyLib)
  packages = ['Try'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/CristianTeodorNita/GITcourse/archive/v_01.tar.gz',    # I explain this later on
